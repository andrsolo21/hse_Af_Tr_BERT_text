...
\begin{document} % конец преамбулы, начало документа
	...
	Принцип работы BERT в настоящее время широко распространен в сфере NLP.
	Модели NLP 
	
	Однако существует большое количество аспектов, которые плохо изучены или вообще не изучены, например, влияние вложений друг на друга в одном предложении.
	Несмотря на то, что эта модель имеет хорошее качество, большинство людей работают с ней, не понимая, что происходит в модели и как модель генерирует результаты.
	Трудно интерпретировать промежуточные данные.
